...
export const AiTankArenaServer = $root.AiTankArenaServer = (() => {
    ...
    AiTankArenaServer.Operation = (function () {
        ...
        Operation.fromObject = function fromObject(object) {
            if (object instanceof $root.AiTankArenaServer.Operation)
                return object;
            let message = new $root.AiTankArenaServer.Operation();
            switch (object.type) {
                case "GET_STATUS":
                case 0:
                    message.type = 0;
        ...
        Operation.toObject = function toObject(message, options) {
            ...
            if (message.type != null && message.hasOwnProperty("type"))
                object.type = options.enums === String ? $root.AiTankArenaServer.OperationType[message.type] : message.type;
            if (message.message != null && message.hasOwnProperty("message"))
